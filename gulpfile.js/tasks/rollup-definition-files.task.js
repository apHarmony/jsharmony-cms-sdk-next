...
const ambientDefs = [
  //nPath.join(paths.srcRoot, 'jsHarmonyCmsPage.d.ts'),
  //nPath.join(paths.srcRoot, 'jsHarmonyCmsRouter.d.ts')
 ];


const defOutputFile = nPath.join(paths.distRoot, 'jsHarmonyCmsSdkNext.d.ts');
